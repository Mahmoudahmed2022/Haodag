import "../Css/TermsofUse2.css";

function TermofUse() {
  return (
    <>
      <div className="big-TermofUse-text-container">
        <div className="header-TermofUse-text">
          <h2>Terms of use</h2>
        </div>
        <div className="body-TermofUse-text">
          <p>
            These Terms of Use constitute a legally binding agreement made
            between you, whether personally or on behalf of an entity (“you”)
            and [business entity name] (“we,” “us” or “our”), concerning your
            access to and use of the Haodag.com website as well as any other
            media form, media channel, mobile website or mobile application
            related, linked, or otherwise connected thereto ("Haodag"). You
            ...
            applicable. <h5>INTELLECTUAL PROPERTY</h5> RIGHTS Unless otherwise
            ...
            Site, the Content and the Marks.<h5>USER REPRESENTATIONS</h5> By
            ...
            you have received parental permission to use the Site. you will not
            access the Site through automated or non-human means, whether
            through a bot, script, or otherwise. you will not use the Site for
            any illegal or unauthorized purpose. your use of the Site will not
